...
USERS = {
    ...
    "dev_user2": UserCredentials("dev_user2", "Qwerty-12345!!", "dev_user2@example.com"),
    "stage_user1": UserCredentials("stage_user1", "stagepass1", "stage_user1@example.com"),
    "stage_user2": UserCredentials("stage_user2", "stagepass2", "stage_user2@example.com"),
}
